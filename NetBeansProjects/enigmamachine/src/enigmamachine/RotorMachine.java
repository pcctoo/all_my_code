...
public class RotorMachine {
    ...
    private final ArrayList<Integer> coprimes;
...
// prompt user for a file and a shift value
// if these values were not provided on the command line
        if (args.length == 0) {
            ...
            System.out.println("Enter the first shift factor 0-25: ");
            int firstShift = input.nextInt();
            System.out.println("Enter the first key 0-25: ");
            int firstKey = input.nextInt();
            System.out.println("Enter the second shift factor 0-25: ");
            int secondShift = input.nextInt();
            System.out.println("Enter the second key 0-25: ");
        ...
        rotorMachine.readFile(); // input
        rotorMachine.encrypt(); // encrypt
        rotorMachine.output(); // output
